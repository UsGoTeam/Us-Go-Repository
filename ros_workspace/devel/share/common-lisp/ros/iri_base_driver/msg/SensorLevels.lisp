...
(cl:in-package iri_base_driver-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <SensorLevels>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SensorLevels)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iri_base_driver-msg:<SensorLevels> is deprecated: use iri_base_driver-msg:SensorLevels instead.")))
