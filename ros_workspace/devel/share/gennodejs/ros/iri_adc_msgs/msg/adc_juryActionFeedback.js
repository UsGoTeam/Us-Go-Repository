...
let adc_juryFeedback = require('./adc_juryFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class adc_juryActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new adc_juryFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = adc_juryFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new adc_juryActionFeedback(null);
    ...
    data.feedback = adc_juryFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += adc_juryFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new adc_juryActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = adc_juryFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new adc_juryFeedback()
    }
...
module.exports = adc_juryActionFeedback;
