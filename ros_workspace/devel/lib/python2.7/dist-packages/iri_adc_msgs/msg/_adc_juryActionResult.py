...
"""autogenerated by genpy from iri_adc_msgs/adc_juryActionResult.msg. Do not edit."""
import codecs
import sys
...
class adc_juryActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "iri_adc_msgs/adc_juryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iri_adc_msgs/adc_juryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(adc_juryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = iri_adc_msgs.msg.adc_juryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = iri_adc_msgs.msg.adc_juryResult()
