...
"""autogenerated by genpy from iri_adc_msgs/adc_juryAction.msg. Do not edit."""
import codecs
import sys
...
class adc_juryAction(genpy.Message):
  _md5sum = "baa6a3def05309cc9806c06ef70e5676"
  _type = "iri_adc_msgs/adc_juryAction"
...
"""
  ...
  _slot_types = ['iri_adc_msgs/adc_juryActionGoal','iri_adc_msgs/adc_juryActionResult','iri_adc_msgs/adc_juryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(adc_juryAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = iri_adc_msgs.msg.adc_juryActionGoal()
      if self.action_result is None:
        self.action_result = iri_adc_msgs.msg.adc_juryActionResult()
      if self.action_feedback is None:
        self.action_feedback = iri_adc_msgs.msg.adc_juryActionFeedback()
    else:
      self.action_goal = iri_adc_msgs.msg.adc_juryActionGoal()
      self.action_result = iri_adc_msgs.msg.adc_juryActionResult()
      self.action_feedback = iri_adc_msgs.msg.adc_juryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.goals.header.seq, _x.action_goal.goal.goals.header.stamp.secs, _x.action_goal.goal.goals.header.stamp.nsecs))
      _x = self.action_goal.goal.goals.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.goals.goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.goals.goals:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.goals.header.seq, _x.action_goal.goal.goals.header.stamp.secs, _x.action_goal.goal.goals.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.goals.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.goals.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.goals.goals = []
      for i in range(0, length):
        ...
        self.action_goal.goal.goals.goals.append(val1)
      _x = self
      start = end
      end += 12
