...
echo_and_run cd "/home/leon/Us-Go-Repository/ros_workspace/src/iri_core/iri_ros_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/home/leon/Us-Go-Repository/ros_workspace/src/iri_core/iri_ros_tools/setup.py" \
     \
    build --build-base "/home/leon/Us-Go-Repository/ros_workspace/build/iri_core/iri_ros_tools" \
    install \
    --root="${DESTDIR-/}" \
